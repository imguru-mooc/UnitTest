...
namespace SalesReportDemo.Tests
{
    ...
    public class SalesReportServiceTests
    {
        ...
        public async Task GenerateAnnualReport_WithMockData_CalculatesGrowthRateCorrectly()
        {
            ...
            var february = monthlyData.First(m => m.Month == 2);
            Assert.AreEqual(66.67, (double)february.GrowthRate, 0.01, "2월 증감률");
            Assert.AreEqual("▲", february.GrowthIndicator, "2월 증감 표시 (상승)");
            
            // 3월: (180,000 - 250,000) / 250,000 * 100 = -28%
            var march = monthlyData.First(m => m.Month == 3);
            Assert.AreEqual(-28.0, (double)march.GrowthRate, 0.01, "3월 증감률");
        ...
        public async Task GenerateAnnualReport_WithMockData_ReturnsTopProductsCorrectly()
        {
            ...
            Assert.AreEqual(51.72, (double)laptop.SalesPercentage, 0.01, "노트북 매출 비율");
            ...
            Assert.AreEqual(27.59, (double)monitor.SalesPercentage, 0.01, "모니터 매출 비율");
            ...
            Assert.AreEqual(10.34, (double)mouse.SalesPercentage, 0.01, "마우스 매출 비율");
            ...
            Assert.AreEqual(10.34, (double)keyboard.SalesPercentage, 0.01, "키보드 매출 비율");
        }
        ...
        public async Task GenerateAnnualReport_WithMockData_ProducesExpectedTableData()
        {
            ...
            {
                { 1, new ExpectedMonthlyData { OrderCount = 3, TotalSales = 150000m, AvgOrder = 50000m, GrowthRate = 0.0, Indicator = "-" } },
                { 2, new ExpectedMonthlyData { OrderCount = 4, TotalSales = 250000m, AvgOrder = 62500m, GrowthRate = 66.67, Indicator = "▲" } },
                { 3, new ExpectedMonthlyData { OrderCount = 2, TotalSales = 180000m, AvgOrder = 90000m, GrowthRate = -28.0, Indicator = "▼" } }
            };
            ...
            {
                new ExpectedProductData { ProductName = "노트북", Quantity = 3, Sales = 300000m, Percentage = 51.72 },
                new ExpectedProductData { ProductName = "모니터", Quantity = 2, Sales = 160000m, Percentage = 27.59 },
                new ExpectedProductData { ProductName = "마우스", Quantity = 4, Sales = 60000m, Percentage = 10.34 },
                new ExpectedProductData { ProductName = "키보드", Quantity = 3, Sales = 60000m, Percentage = 10.34 }
            };
            ...
            foreach (var expected in expectedMonthlyResults)
            {
                ...
                Assert.AreEqual(exp.GrowthRate, (double)actual.GrowthRate, 0.01, 
            ...
            for (int i = 0; i < expectedProductResults.Count; i++)
            {
                ...
                Assert.AreEqual(expected.Percentage, (double)actual.SalesPercentage, 0.01, 
        ...
        private class ExpectedMonthlyData
        {
            ...
            public double GrowthRate { get; set; }  // double로 변경 (Assert.AreEqual delta 비교용)
        ...
        private class ExpectedProductData
        {
            ...
            public double Percentage { get; set; }  // double로 변경 (Assert.AreEqual delta 비교용)
        }
